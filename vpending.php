    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">Pending Request</span>
        ...
        <div class="row">
            <table class="table table-hover table-striped">
			  ...
			  <?php
                            ...
                            $sql1="SELECT * FROM annual.request WHERE lstatus='0'";
                            }
                            if($_SESSION["rights"]=="0"){
                            $sql1="SELECT * FROM annual.request WHERE lstatus='1'";
                            }
...
echo "<td>" . $row['typeofannualleave'] . "</td>";
$ddate=$row['dsub'];
...
echo '<td align="center"><form action="level.php" method="post"><input class="btn btn-success" name=desision type=submit value="Approve" style="width:45%">
   <input type=submit class="btn btn-danger" name=desision value="Reject" style="width:45%">  <input type="hidden"  name="id" value="'. $row['request_id'] .'">'
;
                            }
                            ?>
            </table>
