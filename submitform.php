...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js"></script>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.8.0/css/bootstrap-datepicker.css" hrel="stylesheet"/><!------ Include the above in your HEAD tag ---------->
...
<html lang="en">
  <head>
    ...
    <title>Annual Leave Request Form</title>
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">Request Form</span>
...
<br>
	  ...
	  <div class="col-md-6">
	  <form class="form-horizontal" action="srequest.php" method="post" style="text-align:center;">
	  <h2>Annual Leave Request Form</h2>
    <select id="cproduct" name="product" class="form-control">
            				<option value="Annual Leave"> Annual Leave</option>
                			<option value="Sick Leave"> Sick Leave</option>
                			<option value="Army Leave">Army Leave</option>
                			<option value="Maternity/Paternity Leave"> Maternity/Paternity Leave</option>
</select>
<br>
 <input id="datepicker"  name="datef" width="276"  />
  ...
  inputElement.addEventListener('change', function(e) {
	...
	<br>
	 <input id="datepicker1" name="datet" width="276" />
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script><script type="text/javascript">
 ...
 <div class="form-group">
  <div class="col-md-4">
  <input type="text" name="comments" size="80" style="height:100px;">
  </div>
</div>
 <div class="form-group">
